# HackTruth
⚡ **크롬 익스텐션 설치 방법은 반드시 👉🏻 [HackTruth 소개 페이지](http://15.165.34.51/)를 확인하세요!**  
리드미에는 설치 방법이 포함되어 있지 않으므로, 설치 전 꼭 방문해 주세요.
...
- [HackTruth](#hacktruth)
  ...
  - [백엔드 설정](#백엔드-설정)
    - [환경 변수](#환경-변수)
  - [프런트엔드 설정 (공유 뷰어 및 소개 페이지)](#프런트엔드-설정-공유-뷰어-및-소개-페이지)
...
- 본 서비스 성공률 약 100%, 자체적으로 수집한 데이터 기준
...
- 본 서비스 성공률 약 90%, Huggingface deepfakedetect 성공률 약 60%
